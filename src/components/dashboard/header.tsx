...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-30 h-14 bg-white border-b border-slate-200 flex items-center px-4 md:px-6 gap-4 shrink-0 shadow-sm transition-all duration-300">
      ...
      {/* Global Search Bar (hidden on mobile, shown on md+) */}
      <div className="relative flex-1 max-w-[360px] md:max-w-[420px] hidden sm:block">
      ...
      <div className="flex items-center gap-2.5 md:gap-4">
        ...
        >
          ...
          <span className="absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 bg-blue-600 border-2 border-white rounded-full flex items-center justify-center text-[9px] text-white font-bold leading-none shadow-sm">
            12
          </span>
        </button>
        ...
        <div className="flex items-center gap-2 select-none">
          <div className="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center text-white font-bold text-sm shadow-sm border border-blue-500 hover:bg-blue-700 transition-colors cursor-pointer">
            A
          </div>
